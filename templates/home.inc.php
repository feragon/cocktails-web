...
<main>
    ...
    <h2>Cocktail</h2>
    <p>Un cocktail, pouvant être orthographié coquetel au Québec1, est un mélange de boissons et d’éléments aromatiques et décoratifs en quantité variable. Ils contiennent souvent de l'alcool, mais de très nombreuses recettes en sont dépourvues.
    <br/><br/>
    Quand le mélange d'un cocktail est préparé et conditionné dans un but commercial hors consommation immédiate, il peut être soumis à une réglementation. On parlera alors de prémix. Les mistelles non plus ne sont pas des cocktails.</p>

    <h2>Historique du cocktail</h2>
    <p>Les cocktails se sont répandus à la fin du xviiie siècle, en Angleterre et aux États-Unis. Leur consécration vint pendant la prohibition aux États-Unis, dans les années 1920 : l'ajout d'une autre boisson permettait de masquer le goût d'un alcool de contrebande de mauvaise qualité.
    <br/><br/>
    Jusqu'aux années 1970, les cocktails étaient surtout faits à base de gin, de whisky et de rhum, plus rarement à base de vodka. Au début des années 1980, la vodka est la base la plus répandue des cocktails, remplaçant souvent le gin.</p>

    <h2>Réception</h2>
    <p>Le terme désigne aussi, par métonymie, une réception au cours de laquelle sont servies des boissons, dont des cocktails. Le cocktail en France, appelé autrefois cocktail party, est une réception, où les invités se tiennent généralement debout, à l'inverse d'un dîner placé. Cette réception commence généralement vers 19 heures et précède le dîner, s'il y en a un, et ne le remplace jamais. Les boissons sont accompagnées de petits fours, salés ou sucrés, parfois de canapés, de biscuits secs, ou de cacahuètes, et divers mélanges secs. On organise parfois un buffet, ou un bar, où l'on se sert. Les invités sont également servis par des domestiques apportant des plateaux, lorsqu'il s'agit d'une réception formelle.</p>

    <h2>Étymologie</h2>
    <p>Par traduction directe de l'anglais, cock veut dire « coq » et tail, « queue ». Plusieurs théories, toutes plus ou moins plausibles, sont en lice pour expliquer l'origine du mot. Par exemple « cocktail » viendrait de la contraction de peacock tail (en français : « queue de paon »), compte tenu de sa couleur.
    <br/><br/>
